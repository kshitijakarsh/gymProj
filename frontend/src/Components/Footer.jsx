          ...
          <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            <div class="col-span-2 md:col-span-4 xl:pr-8">
              ...
              <a
                href="/contact"
                title=""
                class="inline-flex items-center justify-center px-6 py-4 font-semibold text-white transition-all duration-200 bg-slate-950 rounded-md hover:bg-slate-950 focus:bg-slate-950 mt-7"
              >
                <svg
                  class="w-6 h-6 mr-2"
